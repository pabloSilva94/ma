  ...
  return (
    <div className="cardContainerList">
            ...
            ? allSchedule.map((schedule) => (
                <Card
                  ...
                  actions={[
                    ...
                    <DeleteFilled
                      key="delete"
                      onClick={() => handleShowModalDelete(schedule)}
                    />,
                  ]}
                >
                  <p>
                  ...
                  <p>
                    <ScheduleOutlined /> {schedule.date}
                  </p>
                  <p>
                    <UserOutlined /> <strong>{schedule.provider.name}</strong>
                  </p>
                </Card>
              ))
            : ""}
      ...
      <ModalEditAgenda
        open={open}
        setOpen={setOpen}
        editOneAgendamento={editOneAgendamento}
        setEditOneAgendamento={setEditOneAgendamento}
      />
      <ModalDeleteAgenda
        open={openDelete}
        setOpen={setOpenDelete}
        deleteOneAgendamento={editOneAgendamento}
      />
    </div>
  );
};
